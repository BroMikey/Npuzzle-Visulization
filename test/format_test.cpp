...
int main() {
    try {
        std::cout << "=== 测试问题文件格式 ===" << std::endl;
        
        // 测试问题文件加载
        ProblemData problem = loadProblem("../data/problem.txt");
        std::cout << "问题文件加载成功！" << std::endl;
        std::cout << "初始状态大小: " << problem.start.size() << std::endl;
        std::cout << "目标状态大小: " << problem.goal.size() << std::endl;
        
        std::cout << std::endl << "=== 测试解决方案文件格式 ===" << std::endl;
        
        // 测试解决方案文件加载
        Solution solution = loadSolution("../data/solution.txt");
        std::cout << "解决方案文件加载成功！" << std::endl;
        ...
        std::cout << std::endl << "=== 所有测试通过！文件格式正确 ===" << std::endl;
